...
public class L03_BasePage {
	...
	public  L03_BasePage() throws IOException {
		prop = new Properties();
		FileInputStream data = new FileInputStream(
				System.getProperty("user.dir") + "\\src\\Section11\\L01_config.properties" );
		prop.load(data);
	}
	...
	public void takeSnapShot(WebDriver webdriver) throws IOException {
		...
		File destFile = new File("C:\\Users\\Andela\\Desktop\\Resources\\screenshots"
				+ timestamp() + ".png");
